<template>
  <div class="screen-container" :style="comtainerStyle">
...
export default {
  ...
  methods: {
    changSize(chartName) {
      ...
      //   // 需要调用每一个图表组件的更新方法(secreenAdapter)
      //   this.$nextTick(() => {
  ...
  computed: {
    // logoSrc() {
    //   return '/static/img/' + getThemeValue(this.themm).logoSrc
    // },
    headerSrc() {
